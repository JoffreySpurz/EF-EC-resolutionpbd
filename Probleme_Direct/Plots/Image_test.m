...
% Avec laser
nom1 = ['Champ de température à Tstop = ' num2str(Tstop)];
...
% Sans laser
nom2 = ['Champ de température à T = ' num2str(T)];
...
% Avec laser
nom3 = ['Gradient de température à Tstop = ' num2str(Tstop)];
...
% Sans laser
nom4 = ['Gradient de température à T = ' num2str(T)];
